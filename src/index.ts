...
/**
 * French Data Protection MCP — stdio entry point.
 *
 * Provides MCP tools for querying CNIL decisions, sanctions, and
...
const TOOLS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        query: {
          type: "string",
          description: "Search query (e.g., 'consentement cookies', 'transfert données', 'Google')",
        },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific CNIL decision by reference number (e.g., 'SAN-2022-009', 'SAN-2023-003').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: {
          type: "string",
          description: "CNIL decision reference (e.g., 'SAN-2022-009', 'MED-2021-015')",
        },
      },
      required: ["reference"],
    },
  },
  {
    ...
    description:
      "Search CNIL guidance documents: guides pratiques, recommandations, referentiels, and FAQs. Covers GDPR implementation, DPIA methodology, cookie consent, privacy by design, and more.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: {
          type: "string",
          description: "Search query (e.g., 'DPIA', 'cookies consent', 'violation données')",
        },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific CNIL guidance document by its database ID.",
    inputSchema: {
      type: "object" as const,
      properties: {
        id: {
          type: "number",
          description: "Guideline database ID (from fr_dp_search_guidelines results)",
        },
      },
      required: ["id"],
    },
