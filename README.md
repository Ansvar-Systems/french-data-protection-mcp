# French Data Protection MCP

**French data protection data for AI compliance tools.**
...
**Endpoint:** `https://mcp.ansvar.eu/french-data-protection/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add french-data-protection-mcp --transport http https://mcp.ansvar.eu/french-data-protection/mcp` |
...
```json
{
  "mcpServers": {
    "french-data-protection-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/french-data-protection/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/french-data-protection-mcp
```
...
```json
{
  "mcpServers": {
    "french-data-protection-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/french-data-protection-mcp"]
    }
  }
}
```
...
- **CNIL (Commission nationale de l'informatique et des libertes)** -- Official regulatory authority
...
>
> Regulatory data is sourced from official publications by CNIL (Commission nationale de l'informatique et des libertes). However:
...
```bash
git clone https://github.com/Ansvar-Systems/french-data-protection-mcp
cd french-data-protection-mcp
npm install
npm run build
npm test
```
